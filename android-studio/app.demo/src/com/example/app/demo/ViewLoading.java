				...
				try {
					...
					ViewLoading.this.runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							tvContent
									.setText("加载完毕\n"
											+ "统计页面加载时间对于应用开发者来说很有意义，试想如果一个页面加载了1分钟还是黑屏，用户还会等吗？\n"+"让OneAPM帮你追究原因，改善用户体验吧！");
					...
					Toast.makeText(ViewLoading.this, "网络图片访问失败，请登录OneAPM追本溯源", 1).show();
					e.printStackTrace();
				}
